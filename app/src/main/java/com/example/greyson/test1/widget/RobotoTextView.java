...
package com.example.greyson.test1.widget;
...
/**
 * Implementation of a {@link android.widget.TextView} with native support for all the Roboto fonts on all versions of Android.
 *
 * @author e.shishkin
 */
